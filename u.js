...
class u extends Helper {
    ...
    /**
      ...
      */
    static async appendField(locator, text) {
    ...
    /**
         ...
         */
    static async checkOption(locator, context) {
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
                await I.scrollIntoView(locator, { behavior: "auto", block: "center", inline: "center" });
            ...
            if (!(0, util_1.isNullOrUndefined)(context)) {
     ...
     *
     */
    static async clearCookie(cookie) {
        try {
            if ((0, util_1.isNullOrUndefined)(cookie)) {
                await I.clearCookie();
            }
            else {
   ...
   */
     ...
     */
    static async dontSee(text, context) {
        try {
            if (!(0, util_1.isNullOrUndefined)(context)) {
     ...
     */
    static async dontSeeCheckboxIsChecked(field) {
        try {
...
*
   * {{> dontSeeCookie }}
   */
    static async dontSeeCookie(cookieName) {
    ...
    /**
      ...
      */
    static async dontSeeCurrentUrlEquals(url) {
    ...
    */
    static async dontSeeElementInDOM(locator) {
    ...
    */
    static async dontSeeInCurrentUrl(verbOrfragmentofText) {
    ...
    */
    static async dontSeeInField(locator, value) {
...
text string (opens new window)value to check. [!] returns a promise which is synchronized internally by recorder
    ...
    */
    static async dontSeeInTitle(text) {
     ...
     */
    static async doubleClick(locator, context) {
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
                await I.scrollIntoView(locator, { behavior: "auto", block: "center", inline: "center" });
    ...
    /**
       ...
       */
    static async dragAndDrop(srcLocator, destLocator) {
        try {
    ...
    */
    static async dragSlider(locator, offset) {
        I.waitForVisible(locator);
        I.dragSlider(locator, offset);
    }
    static async click(locator, context) {
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
                await I.scrollIntoView(locator, { behavior: "auto", block: "center", inline: "center" });
    ...
    static async checkIfVisible(selector, ...options) {
        let flag = false;
        try {
    ...
    /**
         ...
         * @param {any} actual
         */
    static async assertEqual(expected, actual) {
     ...
     */
    static async grabAllWindowHandles() {
     ...
     * @returns {any} window
     */
    static async grabCurrentWindowHandle() {
        let window = await I.grabCurrentWindowHandle();
        return window;
    }
    /**
     ...
     */
    static async grabNumberOfVisibleElements(locator) {
    ...
    */
    ...
    static async resizeWindow(width, height) {
        try {
            if (!(0, util_1.isNullOrUndefined)(height)) {
    ...
    */
    static async rightClick(locator, context) {
        I.waitForVisible(locator);
    ...
    */
    static async saveElementScreenshot(locator, fileName) {
        I.waitForVisible(locator);
     ...
     */
    static async saveScreenshot(fileName, fullPage) {
        if ((0, util_1.isNullOrUndefined)(fullPage)) {
   ...
   */
     ...
     */
    static async switchTo(locator) {
        if (!(0, util_1.isNullOrUndefined)(locator)) {
     ...
     */
    static async switchToNextTab(tabNum) {
     ...
     * @param {string} window
     */
    static async switchToWindow(window) {
     ...
     */
    static async waitForValue(locator, value, timeout) {
        try {
            await I.waitForVisible(locator);
            if ((0, util_1.isNullOrUndefined)(timeout)) {
     ...
     * @param {number} timeout optional, default timeout is value mentioned against key "waitForTimeout"
     */
    static async waitForVisible(locator, timeout) {
        var retry = 2;
        try {
            if (retry > 0) {
                if (!(0, util_1.isNullOrUndefined)(timeout)) {
     ...
     */
    static async waitForText(text, timeout, context) {
        try {
            if (!(0, util_1.isNullOrUndefined)(context) && (0, util_1.isNullOrUndefined)(timeout)) {
                await I.scrollIntoView(context, { behavior: "auto", block: "center", inline: "center" });
                await I.waitForText(text, undefined, context);
            }
            else if (!(0, util_1.isNullOrUndefined)(timeout) && (0, util_1.isNullOrUndefined)(context)) {
            ...
            else if ((0, util_1.isNullOrUndefined)(context) && (0, util_1.isNullOrUndefined)(timeout)) {
     ...
     * @param {number} timeout optional, default timeout is value mentioned against key "waitForTimeout"
     */
    static async waitForInvisible(locator, timeout) {
        try {
            if ((0, util_1.isNullOrUndefined)(timeout)) {
     ...
     * @param {number} timeout optional, default timeout is value mentioned against key "waitForTimeout"
     */
    static async waitForEnabled(locator, timeout) {
        try {
            if ((0, util_1.isNullOrUndefined)(timeout)) {
                await I.waitForEnabled(locator);
            }
     ...
     * @param {number} timeout optional, default timeout is value mentioned against key "waitForTimeout"
     */
    static async waitForClickable(locator, timeout) {
        try {
            if ((0, util_1.isNullOrUndefined)(timeout)) {
                await I.waitForClickable(locator);
            }
     ...
     * @param {number} timeout optional, time in seconds to wait.
     */
    static async switchToPreviousTab(tabNum) {
     ...
     */
    static async scrollIntoView(locator, alignTop) {
     ...
     */
    static async grabTextFrom(locator) {
        let text = "";
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
    ...
    static async grabTextFromAll(locator) {
        let text = [];
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
     ...
     * @param {string} value
     */
    static async fillField(locator, value) {
        try {
    ...
    * @param {string} locator CSS|XPath|strict locator.
     * @param {string} context (optional, null by default) element to search in CSS|XPath|Strict locator.
     */
    static async forceClick(locator, context) {
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
                await I.scrollIntoView(locator, { behavior: "auto", block: "center", inline: "center" });
     ...
     * @returns {string} text
     */
    static async grabAttributeFrom(locator, attribute) {
        let value = "";
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                if (!(process.env.BROWSER === "internet explorer")) {
    ...
    static async grabAttributeFromAll(locator, attribute) {
        let value = [];
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                if (!(process.env.BROWSER === "internet explorer")) {
    ...
    */
    ...
    static async grabCssPropertyFromAll(locator, cssProperty) {
        let postHTML = [];
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
    ...
    */
    static async grabCssPropertyFrom(locator, cssProperty) {
        let postHTML = '';
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
    ...
    */
    static async grabDataFromPerformanceTiming() {
    ...
    */
    static async grabElementBoundingRect(locator) {
        I.waitForVisible(locator);
    ...
    /**
      ...
      */
    static async grabHTMLFrom(locator) {
        let postHTML;
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
...
* @returns {Promise<string>} HTML code for an element
*/
    static async grabHTMLFromAll(locator) {
        let postHTMLs = [];
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
    ...
    *
    */
    static async grabNumberOfOpenTabs() {
        try {
    ...
    */
    static async grabPageScrollPosition() {
    ...
    */
    static async grabTitle() {
        let pageSource = await I.grabTitle();
        return pageSource;
    }
    static async grabValueFromAll(locator) {
        let text = [];
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
     ...
     *
     */
    static async grabValueFrom(locator) {
        let text = "";
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
     ...
     *
     */
    static async moveCursorTo(locator, offsetX, offsetY) {
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
                await I.scrollIntoView(locator, { behavior: "auto", block: "center", inline: "center" });
            }
            if ((0, util_1.isNullOrUndefined)(offsetX) && (0, util_1.isNullOrUndefined)(offsetY)) {
                await I.moveCursorTo(locator);
            }
            else if ((0, util_1.isNullOrUndefined)(offsetX) && !((0, util_1.isNullOrUndefined)(offsetY))) {
   ...
   */
    static async scrollTo(locator, offsetX, offsetY) {
        try {
            if (!(0, util_1.isNullOrUndefined)(offsetX)) {
                await I.scrollTo(locator, offsetX);
            }
            else if (!(0, util_1.isNullOrUndefined)(offsetY)) {
...
*
*/
    static async seeAttributesOnElements(locator, attributes) {
        try {
            await I.wait(2);
     ...
     * @param {string} field  located by label|name|CSS|XPath|strict locator.
     */
    static async seeCheckboxIsChecked(field) {
        try {
            if (field.startsWith("/") || field.startsWith(".") || field.startsWith("#") || field.startsWith("{") || field.startsWith("(")) {
                await I.waitForElement(field);
                await I.scrollIntoView(field, { behavior: "auto", block: "center", inline: "center" });
    ...
    */
    static async seeCssPropertiesOnElements(locator, cssproperties) {
        I.waitForVisible(locator);
    ...
    /**
      ...
      * url string (opens new window)value to check. [!] returns a promise which is synchronized internally by recorder
      */
    static async seeCurrentUrlEquals(url) {
    ...
    locator (string (opens new window)| object (opens new window)) located by CSS|XPath|Strict locator. [!] returns a promise which is synchronized internally by recorder
    */
    static async seeElementInDOM(locator) {
    ...
    *
    Checks that current url does not contain a provided fragment.
    */
    static async seeInCurrentUrl(verbOrfragmentofText) {
     ...
     */
    static async seeElement(locator) {
    ...
    *Parameters
    ...
    Checks that value of input field or textarea doesn't equal to given value Opposite to seeInField
    */
    static async seeInField(locator, value) {
...
text string (opens new window)value to check. [!] returns a promise which is synchronized internally by recorder
    ...
    */
    static async seeNumberOfVisibleElements(locator, num) {
        I.seeNumberOfVisibleElements(locator, num);
    }
    /*
    Checks that text is equal to provided one.
    */
    static async seeTextEquals(text, locator) {
    ...
    */
    static async seeTitleEquals(text) {
     ...
     */
    static async selectOption(locator, option) {
        try {
            if (locator.startsWith("/") || locator.startsWith(".") || locator.startsWith("#") || locator.startsWith("{") || locator.startsWith("(")) {
                await I.waitForElement(locator);
                await I.scrollIntoView(locator, { behavior: "auto", block: "center", inline: "center" });
    ...
    */
    static async setCookie(coockies) {
     ...
     */
    static async type(key, delay) {
        try {
            if ((0, util_1.isNullOrUndefined)(delay)) {
                await I.type(key);
            }
            else {
    ...
    */
    static async uncheckOption(locator, context) {
        I.waitForVisible(locator);
        I.waitForClickable(locator);
        I.uncheckOption(locator, context);
    }
    static async generateLog(timestamp, error) {
